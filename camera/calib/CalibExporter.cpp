...
int CalibExporterClass =
    sofa::core::RegisterObject(
        "Mono / stereo Camera calibration settings exporter")
        .add<CalibExporter>();
...
void CalibExporter::export_cam(cv::Mat KL, cv::Mat TL, cv::Mat RL,
                               cv::FileStorage fs, double e1, cv::Mat dvL,
                               cv::Mat resL)
{
