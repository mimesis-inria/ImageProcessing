#ifndef SOFA_OR_PROCESSOR_CAMERAMODELVIEW_H
#define SOFA_OR_PROCESSOR_CAMERAMODELVIEW_H
...
namespace processor
{
class CameraModelview : public common::ImplicitDataEngine
{
	typedef defaulttype::RigidTypes::Coord Rigid;

 public:
	SOFA_CLASS(CameraModelview, common::ImplicitDataEngine);

	CameraModelview()
			: d_pts2d(initData(&d_pts2d, "pts2d",
	...
	bool poseEstimation(const helper::vector<defaulttype::Vector3>& p3d,
											const helper::vector<defaulttype::Vector2>& p2d,
	...
	Data<helper::vector<defaulttype::Vector2> > d_pts2d;
...
SOFA_DECL_CLASS(CameraModelview)

int CameraModelviewClass = core::RegisterObject(
...
#endif  // SOFA_OR_PROCESSOR_CAMERAMODELVIEW_H
