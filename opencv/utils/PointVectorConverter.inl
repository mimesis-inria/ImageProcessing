...
std::string PointVectorConverter<SrcType, DstType>::templateName(const PointVectorConverter<SrcType, DstType>* /*mapping*/)
{
		return std::string(defaulttype::DataTypeInfo<SrcType>::name()) + "," + defaulttype::DataTypeInfo<DstType>::name();
}
